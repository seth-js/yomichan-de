...
const lr = new LineByLineReader('data/kaikki/kaikki.org-dictionary-German.json');
...
lr.on('end', () => {
  ...
  writeFileSync('data/tidy/german-lemmas.json', JSON.stringify(lemmaDict));
  writeFileSync('data/tidy/german-forms.json', JSON.stringify(formDict));

  console.log('Examples:');
  // console.log(lemmaDict['erklären']);
  // console.log(lemmaDict['Gleichung']);
  // console.log(lemmaDict['Bayern']);
  console.log(lemmaDict['Wurzel']);
  // console.log(formDict['erklärte']);
  // console.log(formDict['Bayern']);
  console.log(formDict['lauf']);
  console.log(formDict['LKW']);

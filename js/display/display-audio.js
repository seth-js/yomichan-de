...
class DisplayAudio {
    constructor(display) {
        // Custom edits =================
        // global altKey variable that wil be used to play raw text rather than deinflected text
        this._altKey = false;
    ...
    _onAudioPlayButtonClick(e) {
        ...
        // Custom edits =================
        // if alt key is held down, it'll try to play the original text
    ...
    async _playAudio(dictionaryEntryIndex, headwordIndex, sources, audioInfoListIndex) {
        ...
        // Custom edits =================
        // replace lemma query with form if alt key was held down
